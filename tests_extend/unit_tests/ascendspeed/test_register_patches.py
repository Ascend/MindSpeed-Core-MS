...
class TestRegisterPatches(DistributedTest):
    ...
    def test_replace_function(self):
        ...
        from unit_tests.ascendspeed.test_register_patches import function1

        assert function1() == 'this is function2'

    def test_wrapper_function(self):
        aspm.register_patch('unit_tests.ascendspeed.test_register_patches.function1', function_wrapper)
        aspm.apply_patches()
    ...
    def test_multi_patch(self):
        aspm.register_patch('unit_tests.ascendspeed.test_register_patches.function1', function2)
        aspm.register_patch('unit_tests.ascendspeed.test_register_patches.function1', function_wrapper)
        aspm.register_patch('unit_tests.ascendspeed.test_register_patches.function1', function_second_wrapper)
        aspm.register_patch('unit_tests.ascendspeed.test_register_patches.function1', function_third_wrapper)
        aspm.apply_patches()
    ...
    def test_double_patch(self):
        ...
        with pytest.raises(RuntimeError, match='the patch of function1 exist !'):
            aspm.register_patch('unit_tests.ascendspeed.test_register_patches.function1', function3)

    def test_force_double_patch(self):
        aspm.register_patch('unit_tests.ascendspeed.test_register_patches.function1', function2)
        aspm.register_patch('unit_tests.ascendspeed.test_register_patches.function1', function3, force_patch=True)
        aspm.apply_patches()
