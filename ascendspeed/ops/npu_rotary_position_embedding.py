import torch
from ascendspeed.op_builder import RotaryPositionEmbeddingOpBuilder


class RotaryPositionEmbeddingFunction(torch.autograd.Function):
    ascendspeed_ops = RotaryPositionEmbeddingOpBuilder().load()

    @staticmethod
    def forward(ctx, x, cos, sin, mode):
        output = RotaryPositionEmbeddingFunction.ascendspeed_ops.\
    ...
    def backward(ctx, grad_outputs):
        ...
        dx, dcos, dsin = RotaryPositionEmbeddingFunction.ascendspeed_ops.\
