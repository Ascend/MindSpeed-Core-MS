...
class NPUDropoutAddLayerNorm(torch.nn.Module):
    def __init__(
        self,
        hidden_size,
        prenorm=False,
    ...
    def forward(self, x0, residual=None, rowscale=None, layerscale=None, return_dropout_mask=False):
        ...
        outputs = ascendspeed_ops.npu_dropout_add_layer_norm(
            x0, self.weight, residual, self.bias, rowscale, layerscale,
            self.p, self.eps, self.prenorm, self.residual_in_fp32, False, return_dropout_mask)
