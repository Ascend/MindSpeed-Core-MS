...
class TestNPUFlashAttention(TestCase):
    ...
    def custom_op_exec(self, query, key, value):
        scale = 0.08838
        #return torch_npu.npu_fusion_attention(
        return ascendspeed_ops.npu_fusion_attention(
            query, key, value, 32, "BSH", None, None, None, scale, 1., 2147483647, 2147483647, 0, None, None, None, 0, True, False)
    ...
    def test_npu_flash_attention(self, device="npu"):
        ...
        self.assertRtolEqual(output[0], attention_score, prec=0.005, prec16=0.005)
