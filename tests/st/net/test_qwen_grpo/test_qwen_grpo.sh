...
rm -rf ${MindSpeed_RL_PATH}/configs/grpo_trainer_qwen25_7b.yaml
cp -r ./configs/grpo_trainer_qwen25_7b.yaml ${MindSpeed_RL_PATH}/configs/
ray stop
python3 ${MindSpeed_RL_PATH}/cli/train_grpo.py --config-name grpo_trainer_qwen25_7b 2>&1 | tee ms_det.txt || true
recover ${filepath1}
recover ${filepath2}
recover ${filepath3}
recover ${filepath4}
