...
MASTER_PORT = 8170
PRETRAIN_POSTFIX = "_ep1tp2pp2_fake"
FINETUNE_POSTFIX = "_ep1tp2pp2_exit_on_missing"
BASE_YAML = "config_mixtral_small.yaml"


class TestExitOnMissing:
    """ A test class for testing --exit-on-missing """
    ...
    def test_mixtral_pynative_exit_on_missing(self):
        """
        Feature: test mixtral pynative
        Description: run pynative mode mixtral to generate pynative loss
        Expectation: test success
        """
        scripts_name = "load_checkpoint.py"
        device_num = 4
        postfix = FINETUNE_POSTFIX
        fake_ckpt_dir = f"output{PRETRAIN_POSTFIX}"
        ...
        with open(base_yaml, "r") as f:
            ...
            conf["load"] = fake_ckpt_dir
            conf["exit_on_missing_checkpoint"] = True
