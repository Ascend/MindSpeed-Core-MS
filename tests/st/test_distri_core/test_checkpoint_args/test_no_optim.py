...
MASTER_PORT = 8150
PRETRAIN_POSTFIX = "_ep1tp2pp2_save_no_optim"
FINETUNE_POSTFIX1 = "_ep1tp2pp2_load_no_optim"
FINETUNE_POSTFIX2 = "_ep1tp2pp2_load_optim"
BASE_YAML = "config_mixtral_small.yaml"


class TestNoOptim:
    """A test class for testing --no-save-optim / --no-load-optim"""
    ...
    def test_mixtral_pynative_no_save_optim(self):
        """
    ...
    def test_mixtral_pynative_no_load_optim(self):
        """
        Feature: test mixtral pynative
        Description: run pynative mode mixtral to generate pynative loss
        Expectation: test success
    ...
    def test_mixtral_pynative_load_optim(self):
        """
        Feature: test mixtral pynative
        Description: run pynative mode mixtral to generate pynative loss
        Expectation: test success
