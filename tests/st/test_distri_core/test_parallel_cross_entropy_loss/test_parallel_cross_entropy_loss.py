...
class TestParallelCrossEntropyLoss:
    ...
    def test_cross_entropy_loss(self):
        ...
        yaml_file = "test_parallel_cross_entropy_loss.yaml"

        scripts_cmd = (f"{scripts_path} --yaml-cfg {yaml_file} "
                       f"--run_mode=cross_entropy_loss")
    ...
    def test_vocab_parallel_cross_entropy_loss(self):
        ...
        scripts_cmd = (f"{scripts_path} --yaml-cfg {yaml_file} "
                       f"--run_mode=vocab_parallel_cross_entropy_loss")
        cmd = f"msrun --worker_num={device_num} " + \
              f"--local_worker_num={device_num} " + \
              "--master_port=8116 " + \
    ...
    def test_cross_entropy_loss_single(self):
        ...
        scripts_cmd = (f"{scripts_path} --yaml-cfg {yaml_file} "
                       f"--run_mode=cross_entropy_loss_single")
        cmd = f"msrun --worker_num={device_num} " + \
              f"--local_worker_num={device_num} " + \
              "--master_port=8119 " + \
    ...
    def test_vocab_parallel_cross_entropy_loss_single(self):
        ...
        scripts_cmd = (f"{scripts_path} --yaml-cfg {yaml_file} "
                       f"--run_mode=vocab_parallel_cross_entropy_loss_single")
        cmd = f"msrun --worker_num={device_num} " + \
              f"--local_worker_num={device_num} " + \
              "--master_port=8119 " + \
    ...
    def test_cross_entropy_loss_dp2(self):
        ...
        scripts_cmd = (f"{scripts_path} --yaml-cfg {yaml_file} "
                       f"--run_mode=cross_entropy_loss_dp2")
        cmd = f"msrun --worker_num={device_num} " + \
              f"--local_worker_num={device_num} " + \
              "--master_port=8117 " + \
    ...
    def test_vocab_parallel_cross_entropy_loss_dp2(self):
        ...
        scripts_cmd = (f"{scripts_path} --yaml-cfg {yaml_file} "
                       f"--run_mode=vocab_parallel_cross_entropy_loss_dp2")
        cmd = f"msrun --worker_num={device_num} " + \
              f"--local_worker_num={device_num} " + \
              "--master_port=8117 " + \
