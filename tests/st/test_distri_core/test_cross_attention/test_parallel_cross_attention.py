...
# ============================================================================
"""Test ParallelAttention with CrossAttention"""
import os
import pytest
...
class TestCrossAttention:
    """
    Compare ParallelAttention of legacy (Transformer V1) with SelfAttention
        of mcore (Transformer V2)
    """
    ...
    def test_cross_attention_mcore(self):
        """
