...
from mindspeed_ms.core.config import OptimizerConfig, ModelParallelConfig, TransformerConfig, TrainingConfig
...
def run_golden_optimizer():
    ...
    training_config = TrainingConfig(parallel_config)
