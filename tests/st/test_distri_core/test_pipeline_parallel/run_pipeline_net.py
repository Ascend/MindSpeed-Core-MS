...
from mindspeed_ms.core.parallel_state import (initialize_model_parallel, get_data_parallel_group,
                                              get_pipeline_model_parallel_group, get_pipeline_model_parallel_rank,
                                              get_pipeline_model_parallel_world_size)
from mindspeed_ms.training import TrainOneStepCell, train, get_model
from mindspeed_ms.core.config import (init_configs_from_yaml, TrainingConfig, ModelParallelConfig, TransformerConfig,
...
if __name__ == '__main__':
    ...
    if args.run_mode == 'custom_pp_with_share':
