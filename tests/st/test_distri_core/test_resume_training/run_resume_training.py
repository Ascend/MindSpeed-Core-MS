...
from mindspeed_ms.core.parallel_state import (get_data_parallel_group, get_expert_model_parallel_group,
                                              get_tensor_model_parallel_group, get_pipeline_model_parallel_group,
                                              get_data_parallel_rank, get_expert_model_parallel_rank,
...
def run_resume_training(config, args):
    ...
    init()
    initialize_model_parallel(tensor_model_parallel_size=tp, expert_model_parallel_size=ep,
    ...
    # train
    train(train_one_step_cell, dataset, config, resume_dict=resume_dict)
