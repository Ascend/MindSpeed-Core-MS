...
def set_parallel_context(parallel_config=None):
    """
    ...
    initialize_model_parallel(
        tensor_model_parallel_size=parallel_config.tensor_model_parallel_size if parallel_config else 1,
        pipeline_model_parallel_size=parallel_config.pipeline_model_parallel_size if parallel_config else 1,
        virtual_pipeline_model_parallel_size=(
            parallel_config.virtual_pipeline_model_parallel_size if parallel_config else None
        ),
