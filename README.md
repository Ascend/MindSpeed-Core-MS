...
| MSAdapter        | [v0.5.0](https://openi.pcl.ac.cn/OpenI/MSAdapter/src/tag/v0.5.0)                                                                               |
| Python           | >=3.9                                                                                                                              |
...
- [**DEEPSEEK-V3预训练**](https://gitcode.com/Ascend/MindSpeed-LLM/blob/2.2.0/examples/mindspore/deepseek3/README.md)
...
- [**Qwen2.5VL 微调**](https://gitcode.com/ascend/MindSpeed-MM/blob/2.2.0/examples/mindspore/qwen2.5vl/README.md)
