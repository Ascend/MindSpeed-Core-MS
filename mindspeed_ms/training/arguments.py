...
# pylint: disable=W0102, W0105, W1508, C0330
def validate_args(args, default_args, defaults={}):
    """Validate args from command line"""
    # Warn if unused args are set.
    check_unused_args(args, default_args, UNUSED_MODEL_PARALLEL_CONFIG)
    check_unused_args(args, default_args, UNUSED_TRANSFORMER_CONFIG)
    check_unused_args(args, default_args, UNUSED_GLOBAL_ARGS)
...
def _add_profile_args(parser):
    ...
    group.add_argument('--profile-level', type=str, default='level0', choices=['level0', 'level1', 'level2'], help='profiling "level0", "level1", "level2"')
    ...
    group.add_argument('--profile-no-op-time', action='store_false', dest='profile_op_time', help='profiling with op time info')
