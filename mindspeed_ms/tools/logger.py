...
from .utils import get_num_nodes_devices, get_rank_info, \
...
class _DataFormatter(logging.Formatter):
    ...
    def format(self, record):
        ...
        ms_install_home_path = 'mindspeed_ms'
...
def get_logger(logger_name: str = 'mindspeed_ms', **kwargs) -> logging.Logger:
...
class logger:
    ...
    def info(cls, msg, *args, **kwargs):
        """Log a message with severity 'INFO' on the mindspeed_ms logger."""
        get_logger().info(msg, *args, **kwargs)

    @classmethod
    def debug(cls, msg, *args, **kwargs):
        """Log a message with severity 'DEBUG' on the mindspeed_ms logger."""
        get_logger().debug(msg, *args, **kwargs)

    @classmethod
    def error(cls, msg, *args, **kwargs):
        """Log a message with severity 'ERROR' on the mindspeed_ms logger."""
        get_logger().error(msg, *args, **kwargs)

    @classmethod
    def warning(cls, msg, *args, **kwargs):
        """Log a message with severity 'WARNING' on the mindspeed_ms logger."""
        get_logger().warning(msg, *args, **kwargs)

    @classmethod
    def critical(cls, msg, *args, **kwargs):
        """Log a message with severity 'CRITICAL' on the mindspeed_ms logger."""
