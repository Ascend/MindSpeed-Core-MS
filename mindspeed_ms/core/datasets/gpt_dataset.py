...
from mindspeed_ms.core.datasets.utils import Split, log_single_rank
...
def _build_shuffle_index(
    ...
    Args:
        ...
        total_size (int): The size of the entire index.

        If larger than 'num_samples', it defines the second shuffle range [num_samples, total_size)
