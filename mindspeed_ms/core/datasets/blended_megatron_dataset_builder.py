...
from mindspeed_ms.core.parallel_state import get_virtual_pipeline_model_parallel_rank
...
DistributedDataset = Union[
    TopLevelDataset, MidLevelDataset, LowLevelDataset
]
...
class BlendedMegatronDatasetBuilder(object):
    ...
    def __init__(
        ...
        if mindspore.communication._comm_helper._is_initialized():
            gb_rank = mindspore.mint.distributed.get_rank()
    ...
    def _build_megatron_datasets_parallel(
        ...
        if mindspore.communication._comm_helper._is_initialized():
            rank = mindspore.mint.distributed.get_rank()
            ...
            if rank == 0:
                ...
                if num_workers > 1:
                    ...
                    num_workers *= min(2, max(1, mindspore.hal.device_count()))
                _threading_helper(
                    megatron_datasets,
                    num_workers,
                    prefixes,
    ...
    def build_generic_dataset(
        ...
        *args: Any,
        ...
        and mindspore.communication is initialized.
