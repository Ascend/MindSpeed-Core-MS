...
from mindspeed_ms.core.models.common.embeddings.language_model_embedding import LanguageModelEmbedding
from mindspeed_ms.core.models.common.embeddings.rotary_pos_embedding import RotaryEmbedding
from mindspeed_ms.core.models.common.language_module.language_module import LanguageModule
from mindspeed_ms.core.transformer.enums import ModelType
from mindspeed_ms.core.transformer.spec_utils import ModuleSpec
...
class GPTModel(LanguageModule):
    ...
    Args:
        ...
        rotary_base (int, optional): Base period for rotary position embeddings.
            Ignored unless position_embedding_type is 'rope'. Defaults to 10000.
        seq_len_interpolation_factor (Optional[float], optional): scale of linearly interpolating RoPE
    ...
    def __init__(
        ...
        # mindspeed_ms core pipelining currently depends on model type
        ...
        if post_process:
            if self.config.defer_embedding_wgrad_compute:
                raise NotImplementedError("`defer_embedding_wgrad_compute` is not supported "
                                          "for now.")
            else:
    ...
    def set_input_tensor(self, input_tensor: Tensor) -> None:
        ...
        See mindspeed_ms.model.transformer.set_input_tensor()
